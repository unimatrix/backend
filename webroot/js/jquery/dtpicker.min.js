...
/**
 * jQuery DateTimePicker - iOS fix
 * Version 0.1.38
 * minified with http://closure-compiler.appspot.com/home
 */
var iOS=/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream;
if(iOS){var dtpickerContMoveiOS=function(){if(iOS){var a=document.documentElement.clientHeight/2+(window.scrollY||window.pageYOffset||document.documentElement.scrollTop)+"px";jQuery(".dtpicker-mobile").css("position","absolute");jQuery(".dtpicker-cont").css("position","absolute");jQuery(".dtpicker-cont").css("top",a)}};window.addEventListener?(window.addEventListener("load",dtpickerContMoveiOS,!1),window.addEventListener("scroll",dtpickerContMoveiOS,!1)):window.attachEvent?(window.attachEvent("onload",
dtpickerContMoveiOS),window.attachEvent("onscroll",dtpickerContMoveiOS)):(window.onload=dtpickerContMoveiOS,window.onscroll=dtpickerContMoveiOS);$(function(){$("input[readonly]").on("focus",function(a){$(this).trigger("blur")})})};
